...
async def start(b, m):
    ...
    if usr_cmd == "/start":
            ...
            try:
                ...
                await b.send_message(
                    ...
                    reply_markup=InlineKeyboardMarkup(
                        [
                            [
                                InlineKeyboardButton("𝙹𝙾𝙸𝙽 𝚄𝙿𝙳𝙰𝚃𝙴𝚉 𝙲𝙷𝙰𝙽𝙽𝙴𝙻", url=f"https://t.me/SageMods")
                            ]
                        ]
                    )
        ...
        await b.send_message(
            ...
            reply_markup=InlineKeyboardMarkup(
                [
                    [InlineKeyboardButton("⚡ ᴊᴏɪɴ ᴍᴀɪɴ ᴄʜᴀɴɴᴅʟ ⚡", url="https://t.me/SageMods")],
